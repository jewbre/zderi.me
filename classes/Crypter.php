...
class Crypter {
    ...
    private static $pass = "aslkdfjlasdf";
...
$cryptedData = Crypter::encrypt(json_encode($data));

echo Crypter::decrypt("Q0E3QTYxQTL8vh548KP3rUMwMDW1R9gC5Exxf0REOEU3SHpYQ0pEQTQwRUYyaXZxWDZ6YjA0OTBBNUMzM0RGRWJac25kcFhC");